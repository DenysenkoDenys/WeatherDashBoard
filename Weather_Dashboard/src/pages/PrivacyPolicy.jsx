...
const PrivacyPolicy = () => {
    return (
        <div style={{ padding: "20px", margin: "0 auto", lineHeight: "1.6" }}>
            <h1 style={{textAlign: "center", marginLeft: "100px"}}>Політика конфіденційності</h1>
            <p>
                <b>Дата останнього оновлення: 26 лютого, 2025.<br/></b>
            ...
            <ul>
                ...
                <li>з метою перевірки відповідності умовам та правилам, які регламентують використання нашого веб-сайту (включаючи моніторинг приватних повідомлень, надісланих через сервіс приватних повідомлень нашого веб-сайту);</li>
            ...
            <ul>
                ...
                <li>у зв’язку з будь-якими поточними або майбутніми судовими процесами;</li>
            ...
            <h2>Міжнародні передачі персональної інформації</h2>
            <p>
            ...
            <h2>Збереження персональної інформації</h2>
            <p>
            ...
            <p>
                Без обмежень положень, зазначених в пункті Є-2, ми зазвичай видаляємо персональну інформацію
            </p>
            ...
            <h2>Захист вашої персональної інформації</h2>
            <p>
            ...
            <ul>
                <li>оплата зборів та надання відповідних підтверджень вашої особи</li>
                <li>(ВВЕДІТЬ ТЕКСТ ДЛЯ ВІДОБРАЖЕННЯ ВАШИХ ПРАВИЛ, ми зазвичай приймаємо фотокопію вашого паспорта, завірену нотаріусом, та оригінальну копію рахунку на сплату за комунальні послуги для підтвердження вашої поточної адреси).</li>
            </ul>
            <p>
            ...
            <ul>
                <li>в Internet Explorer (версія 10), ви маєте видаляти файли-cookie вручну (інструкцію, як це зробити, можна знайти за адресою http://support.microsoft.com/kb/278835 );</li>
